	...
	if(data1!=null && data1.length>0){
		for(var i = 0;i<data1.length;i++){
			...
			if(obj.checkStatus == 0){
				str += "<td><li style='color: red'>"+obj.newsConent+"</li></td><td style='display: none;'><a href='#' onclick='realread("+obj.id+")' data-toggle='modal'>已读</a> 	&ensp; 	&ensp; 	&ensp;<a href='#' onclick='delInformation("+obj.id+");' data-toggle='modal'>删除</a></td>";
			}
			
			if(obj.checkStatus == 1){
				str += "<td><li style='color: gary'>"+obj.newsConent+"</li></td><td style='display: none;'>&ensp; 	&ensp;<a href='#' onclick='delInformation("+obj.id+");' data-toggle='modal'>删除</a></td>";
			}
		}
	}else{
		str += "<tr>";
